...
namespace AtCoder.CS
{
    public readonly struct MInt
    {
        ...
        public static MInt operator /(MInt a, MInt b) => a.Value * b.GetInverse();
        public static MInt operator /(MInt a, long b) => a.Value * GetInverse(b);
        public static bool operator ==(MInt a, MInt b) => a.Value == b.Value;
        public static bool operator !=(MInt a, MInt b) => a.Value != b.Value;
        public override int GetHashCode() => Value.GetHashCode();
        public override string ToString() => Value.ToString();

        public long GetInverse() => GetInverse(Value);
